const translations = {
    "th": {
        ...
        "btn_book": "จองโต๊ะ", "btn_order": "สั่งอาหาร", "btn_back": "กลับ", "btn_logout": "ออกจากระบบ",
        ...
        "alert_no_slip": "กรุณาอัพโหลดสลิปโอนเงินก่อนยืนยันค่ะ", "alert_pay_success": "ชำระเงินสำเร็จ! กำลังส่งออเดอร์ไปที่ร้านค้า",
        
        // --- หน้า Status ---
        "status_title": "สถานะออเดอร์", "status_cooking": "กำลังทำ", "status_done": "เสร็จสิ้น",
        "status_wait": "กรุณารออาหารสักครู่ค่ะ...", "status_ready": "อาหารของคุณเสร็จเรียบร้อยแล้ว! เชิญมารับได้ที่หน้าร้านค่ะ",
        "alert_order_ready": "ออเดอร์คิวที่ 1 เสร็จเรียบร้อยแล้วค่ะ!", "btn_home": "กลับหน้าหลัก"
    },
    "en": {
        "title_main": "Book a Table & Order Food",
        "btn_book": "Book Table", "btn_order": "Order Food", "btn_back": "Back", "btn_logout": "Logout",
        ...
        "alert_order_ready": "Order Queue 1 is ready!", "btn_home": "Back to Home"
    }
};
